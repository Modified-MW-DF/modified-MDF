-- Adds a pull animal to the civ. Pull animals pull the wagons in caravans. Two of them are offered at embark.
--[=[
    Adds a pull animal to the civ. Pull animals pull the wagons in caravans. Two of them are offered at embark.
    ...
    Example : AddPullToCiv -civ MOUNTAIN -race DOG -caste MALE
]=]
