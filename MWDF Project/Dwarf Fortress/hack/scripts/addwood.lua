...
k=0
	while k < #my_entity.resources.organic.wood.mat_index do
		...
		if (sText==nil) then
			--LIQUID barrels
			my_entity.resources.organic.wood.ALDER:insert(k)
			my_entity.resources.organic.wood.ALDER:insert(k)
			k=k-1
		else
			if(sText.material.id=="WOOD") then
				if(sText.plant.id=="ALDER") then
					my_entity.resources.organic.wood.mat_type:insert(k)
					my_entity.resources.organic.wood.mat_index:insert(k)
					k=k-1
				end
			end
		end
...
k=0
	while k < #my_entity.resources.misc_mat.crafts.mat_index do
		...
		if (sText==nil) then
			--LIQUID barrels
			my_entity.resources.misc_mat.crafts.mat_type:insert(k)
			my_entity.resources.misc_mat.crafts.mat_index:insert(k)
			k=k-1
		else
			if(sText.material.id=="WOOD") then
				if(sText.plant.id=="ALDER") then
...
k=0
	while k < #my_entity.resources.misc_mat.barrels.mat_index do
		...
		if (sText==nil) then
			--LIQUID barrels
			my_entity.resources.misc_mat.barrels.mat_type:insert(k)
			my_entity.resources.misc_mat.barrels.mat_index:insert(k)
			k=k-1
		else
			if(sText.material.id=="WOOD") then
				if(sText.plant.id=="ALDER") then
...
k=0
	while k < #my_entity.resources.misc_mat.wood2.mat_index do
		...
		if (sText==nil) then
			--LIQUID wood2
			my_entity.resources.misc_mat.wood2.mat_type:insert(k)
			my_entity.resources.misc_mat.wood2.mat_index:insert(k)
			k=k-1
		else
			if(sText.material.id=="WOOD") then
				if(sText.plant.id=="ALDER") then
...
k=0
	while k < #my_entity.resources.misc_mat.cages.mat_index do
		...
		if (sText==nil) then
			--LIQUID cages
			my_entity.resources.misc_mat.cages.mat_type:insert(k)
			my_entity.resources.misc_mat.cages.mat_index:insert(k)
			k=k-1
		else
			if(sText.material.id=="WOOD") then
				if(sText.plant.id=="ALDER") then
